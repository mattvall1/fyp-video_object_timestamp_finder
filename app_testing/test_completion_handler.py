...
class TestCompletionHandler(unittest.TestCase):
    ...
    def test_init(self):
        self.assertEqual(self.completion_handler.element_handler, self.mock_element_handler)
    ...
    def test_setup_pdf(self, mock_canvas):
        ...
        mock_canvas_instance.setTitle.assert_called_once_with("Completion Report for video_test")

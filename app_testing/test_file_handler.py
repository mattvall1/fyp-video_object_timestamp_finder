...
class TestFileHandler(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_element_handler.search_term_handler.compare_caption_to_search_term.return_value = ["test"]
        ...
        self.frame_displayer_patch = patch('app.processing.frame_display.FrameDisplayer', autospec=True)
        ...
        self.setup_caption_patch = patch('app.processing.file_handler.FileHandler._setup_caption_file')
        ...
        with patch('app.processing.file_handler.FrameDisplayer', self.mock_frame_displayer_class):
            self.file_handler = FileHandler(self.test_file_path, self.mock_element_handler)
    ...
    def test_retrieve_keyframes(self, mock_process_keyframes, mock_key_frame_handler_class):
    ...
    def test_process_keyframes(self, mock_completion_handler_class, mock_image_captioning_handler_class, mock_listdir):
        # Mock frame listing
        ...
        self.mock_element_handler.generate_report_modal.return_value = "/test/report/path"
        ...
        mock_completion_handler.generate_completion_report.assert_called_once_with("/test/report/path")

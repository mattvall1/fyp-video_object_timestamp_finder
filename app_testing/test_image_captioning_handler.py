...
class TestImageCaptioningHandler(unittest.TestCase):
    def setUp(self):
        ...
        self.automodel_patch = patch('app.processing.image_captioning_handler.AutoModelForCausalLM')
        ...
        self.autoprocessor_patch = patch('app.processing.image_captioning_handler.AutoProcessor')
        ...
        self.captioning_handler = ImageCaptioningHandler(original_output_dir=self.test_output_dir)
    ...
    def test_init(self):
        ...
        with patch('app.processing.image_captioning_handler.AutoModelForCausalLM') as mock_model:
            with patch('app.processing.image_captioning_handler.AutoProcessor') as mock_processor:
    ...
    @patch('app.processing.image_captioning_handler.ImageCaptioningHandler._get_caption')
    def test_frame_caption(self, mock_get_caption):
        ...
        mock_get_caption.assert_called_once_with(f"{self.test_output_dir}/{self.test_frame}")
